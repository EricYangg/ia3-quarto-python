...
@tbl-horse-sd-table. Standard deviation of historical (1906-1972) horse populations for each Canadian province.

```{python}
#| label: tbl-horse-sd-table
...
Additionally, note that in @tbl-horse-sd-table we consider the sample standard deviation of the number of horses during the same time span as Figure 1.
